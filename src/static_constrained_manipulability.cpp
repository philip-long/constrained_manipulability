...
namespace constrained_manipulability
{
    ...
    Polytope ConstrainedManipulability::getAllowableMotionPolytope(KDL::Chain &chain,
                                                                   urdf::Model &model,
                                                                   ...
                                                                   double linearization_limit)
    {
        ...
        Polytope vrep_polytope("allowable_motion_polytope", Ahrep_undeformed, bhrep_underformed);
    ...
    Polytope ConstrainedManipulability::getVelocityPolytope(KDL::Chain &chain,
                                                            urdf::Model &model,
                                                            const sensor_msgs::JointState &joint_states,
                                                            Eigen::MatrixXd &AHrep,
                                                            Eigen::VectorXd &bhrep)
    {
        ...
        // Convert to V-representation polytope
        Polytope vrep_polytope("velocity_polytope", Ahrep_undeformed, bhrep_underformed);
        vrep_polytope.transformCartesian(base_J_ee.topRows(3), base_T_ee.translation());
